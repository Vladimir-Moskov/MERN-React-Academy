...
const redirectUris: any = 'http://localhost:3001/oauthExample/callback'.split(',').map((item) => {
    return item.trim();
});

const defaultClient: any = new ClientModel({
    id: 'd092425c6309f9a386a383a830e3b1d187ddc552',
    secret: 'a00e4219668043ccb46cf1cb4be25642d0a65aa0',
    type: 'confidential',
