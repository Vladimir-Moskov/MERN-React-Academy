...
import { BookInstanceComponent } from '../../components/Catalog';
...
/**
 * GET method route
 * @example http://localhost:PORT/v1/catalog/book
 * 
 * @swagger
 ...
 */
router.get('/', BookInstanceComponent.findAll);
 ...
 */
router.get('/:id', BookInstanceComponent.findOne);
